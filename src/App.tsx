...
function App() {
  ...
  const [url, setUrl] = useState(
    'http://golang-demo-git-myapp.apps.68.sandbox1017.opentlc.com/jump'
  );
      ...
      <body className='App-body'>
        <form onSubmit={handleSubmit}>
          <div className='App-body-settings'>
            ...
            <button className='add-button' type='button' onClick={addInput}>
              Add new jump...
            </button>
          </div>
          ...
          <div className='App-body-calls'>
            ...
            <div>
              <button className='jump-button' type='submit'>
                Jump
              </button>
            </div>
          </div>
